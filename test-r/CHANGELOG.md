...
- Auto-derived case tags and matrix-suite support ([#181](https://github.com/vigoo/test-r/pull/181))
...
- Capturing improvements ([#177](https://github.com/vigoo/test-r/pull/177))
...
- Fixes ([#172](https://github.com/vigoo/test-r/pull/172))

## [3.0.7](https://github.com/vigoo/test-r/compare/test-r-v3.0.6...test-r-v3.0.7) - 2026-05-26

### Other

- Fixes ([#170](https://github.com/vigoo/test-r/pull/170))
...
- apply suite tags to submodules ([#163](https://github.com/vigoo/test-r/pull/163))

## [3.0.3](https://github.com/vigoo/test-r/compare/test-r-v3.0.2...test-r-v3.0.3) - 2026-03-02

### Added

- still output test run summary to stderr when using the ctrf or junit reporters ([#158](https://github.com/vigoo/test-r/pull/158))
